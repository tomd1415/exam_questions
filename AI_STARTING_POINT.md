...
├── docs/                       generated/published descriptors (e.g. widgets.schema.json — registry snapshot, regenerated by `npm run gen:widgets-schema`)
├── scripts/                    db-init, backup, restore drill, Phase 0/1 human-test walkers, gen-widgets-schema
