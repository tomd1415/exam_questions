...
| 5   | Find the open-response part `(b)`.                                                                                                                                                                                                                                                                                                                                                                                                                                                | The part shows `pending / <marks>` and the sentence **"Your teacher will mark this — come back later."**. There is NO **Model answer:** section on this part.                                                                                    |
| 6   | View page source (Ctrl-U). Search for `RUBRIC-LEAK-CHECK`.                                                                                                                                                                                                                                                                                                                                                                                                                        | Zero matches. The teacher's rubric text for open-response parts never reaches the pupil DOM.                                                                                                                                                     |
...
- [ ] Pending parts showed exactly the phrase **"Your teacher will mark
      this — come back later."** with no further teacher-only details.
