...
| 3   | Submit the form **with no data**.                                                                                          | Browser blocks submission (HTML `required` attributes). If you bypass with curl, server returns 400 with "Please fill in both fields."                                                                       | —                                                                                                                                                                                                                                     |
